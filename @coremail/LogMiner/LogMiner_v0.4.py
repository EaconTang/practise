...
from functions import grep_lines,option_parser,color_wrap
import json,yaml
import codecs
...
# step 3: traverse section_lsit and options_lsit, find the exception lines
print '正在处理log...'
res_lines = {}
res_count = {}
...
for each_res in res_count_sorted:
    ptable.add_row([each_res[0],each_res[1]])
ptable_str = ptable.get_string(sortby='Count',reversesort=True)
